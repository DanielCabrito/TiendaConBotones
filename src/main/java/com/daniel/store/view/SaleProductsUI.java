...
public class SaleProductsUI extends javax.swing.JFrame {
    ...
    private final SaleProductDAO saleProductDao = new SaleProductDAO();
    ...
    /**
     * Al iniciar el UI hay que: 1. Cargar el UI (initComponents() ) 2. Cargar
     * Productos de la base de datos (tabla PRODUCTOS) 3. Inicir un objeto Sale
    ...
    private void addToShoppingCar() {
        ...
        this.jTextFieldTotal.setText(String.valueOf(currentSale.getSubtotal()));
    ...
    private void calculateTotal() {
        try {
            ...
            if (cantidad > selectedProduct.getStock()) {
                ...
                //agregar el eliminar el nombre del producto del carrito cuando no alla inventario
                return;
            }
    ...
    private void initComponents() {
        ...
        jLabelPrecioUnidad1.setText("Subtotal:");
        jPanel.add(jLabelPrecioUnidad1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 340, -1, -1));
        ...
        jLabelPrecioUnidad.setText("Total:");
        jPanel.add(jLabelPrecioUnidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 400, -1, -1));
    ...
    public DefaultListModel eliminarDatos() {
        ...
        modelo.remove(jListCarrito.getAnchorSelectionIndex());
        return modelo;
    }
}
